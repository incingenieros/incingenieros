...
export default function ContentEditor() {
  ...
  const [content, setContent] = useState<Content>({
    hero: {
      es: {
        ...
        description:
          "Con más de 20 Años de Experiencia, brindo soluciones técnicas y asesoramiento especializado para el sector marítimo, offshore e industrial.",
      ...
      en: {
        ...
        description:
          "With over 20 Years of Experience, I provide technical solutions and specialized consulting for the maritime, offshore and industrial sectors.",
        button: "View my Work",
      ...
      ca: {
        ...
        description:
          "Amb més de 20 Anys d'Experiència, ofereixo solucions tècniques i assessorament especialitzat per al sector marítim, offshore i industrial.",
    ...
    features: {
      es: {
        ...
        description:
          "Diseño y cálculos estructurales para plataforma de trabajo en alta mar.",
        services: [
          {
            title: "Diseño Naval",
      ...
      en: {
        ...
        description:
          "Design and structural calculations for offshore work platforms.",
        services: [
          {
            title: "Naval Design",
      ...
      ca: {
        ...
        description:
          "Disseny i càlculs estructurals per a plataforma de treball en alta mar.",
        services: [
          {
            title: "Consultoria",
            description:
              "Assessorament especialitzat en projectes navals i industrials.",
            icon: "chart-bar",
          },
          {
            title: "Disseny Naval",
          ...
          },
          {
            ...
            description:
              "Solucions per a la indústria i processos de fabricació.",
            icon: "cog",
          },
        ],
      },
    ...
    specialization: {
      es: {
        ...
        description:
          "Competencias técnicas y experiencia en diferentes campos de la ingeniería naval y oceánica, desarrolladas a lo largo de más de dos décadas de trayectoria profesional.",
        items: [
          {
            title: "Diseño Naval",
            description:
      ...
      en: {
        ...
        description:
          "Technical skills and experience in various fields of naval and ocean engineering, developed over more than two decades of professional career.",
        items: [
          {
            title: "Naval Design",
            description:
              "Design and structural calculation of commercial vessels, recreational boats, and offshore platforms using specialized software.",
          },
          {
            title: "Maritime Regulations",
            description:
              "Specialist in international regulations (IMO, SOLAS, MARPOL) and certifications for vessels and marine structures.",
          },
          {
            title: "Offshore Engineering",
            description:
              "Development of solutions for offshore platforms and structures under extreme conditions, with emphasis on safety and efficiency.",
          },
        ],
      },
      ca: {
        ...
        description:
          "Competències tècniques i experiència en diferents àmbits de l’enginyeria naval i oceànica, desenvolupades al llarg de més de dues dècades de trajectòria professional.",
        items: [
          {
            title: "Disseny Naval",
            description:
              "Disseny i càlcul estructural d’embarcacions comercials, d’esbarjo i plataformes offshore amb programari especialitzat.",
          },
          {
            title: "Normativa Marítima",
            description:
              "Especialista en normativa internacional (IMO, SOLAS, MARPOL) i certificacions per a embarcacions i estructures marines.",
          },
          {
            title: "Enginyeria Offshore",
            description:
              "Desenvolupament de solucions per a plataformes i estructures marines en condicions extremes, amb èmfasi en la seguretat i l’eficiència.",
          },
        ],
      },
    },
    ...
    testimonials: {
      ...
      ca: {
        ...
        description:
          "El que diuen els nostres clients sobre els nostres serveis.",
        testimonials: [
          {
            name: "Carlos Rodríguez",
    ...
    industrial: {
      es: {
        ...
        description:
          "Ofrezco servicios de consultoría técnica especializada para proyectos marítimos, navales e industriales, aportando soluciones eficientes y personalizadas a cada cliente.",
        ...
        projects: [
          {
            ...
            category: "Naval",
            description:
              "Realizo un análisis detallado de proyectos en fases iniciales o en curso, teniendo en cuenta la normativa vigente, la viabilidad técnica y el impacto económico. Los informes que elaboro están diseñados para servir como herramienta en la toma de decisiones estratégicas.",
          ...
          },
          {
            ...
            category: "Industrial",
            description:
              "Determino si un proyecto es viable desde los puntos de vista técnico, económico y logístico. Esta evaluación permite anticipar obstáculos, estimar recursos necesarios y definir un plan de acción efectivo.",
          ...
          },
          {
            ...
            category: "Offshore",
            description:
              "Acompaño la ejecución de proyectos asegurando que se cumplan los estándares técnicos, los plazos de entrega y los criterios de calidad. La supervisión puede ser puntual o continua, en función del alcance de la obra.",
          ...
          },
          {
            ...
            category: "Naval",
            description:
              "Identifico oportunidades de mejora en líneas de producción o ejecución de proyectos, con el objetivo de reducir tiempos, costos y errores. Trabajo con metodologías como Lean Manufacturing y Six Sigma.",
            image: "/images/projects/project-1.jpg",
          },
          {
            ...
            category: "Industrial",
            description:
              "Acompaño a empresas y proyectos durante los procesos de certificación técnica y clasificación de buques o instalaciones, colaborando con entidades reconocidas como Bureau Veritas, DNV, Lloyd's Register o ABS.",
            image: "/images/projects/project-2.jpg",
          },
          {
            ...
            category: "Offshore",
            description:
              "Brindo soporte técnico a empresas que participan en proyectos internacionales, asegurando la adaptación a normativas locales e internacionales, la coordinación entre equipos multidisciplinares y el seguimiento de estándares de calidad globales.",
            image: "/images/projects/project-3.jpg",
          },
        ],
      },
      en: {
        ...
        description:
          "I offer specialized technical consulting services for maritime, naval and industrial projects, providing efficient and customized solutions to each client.",
        ...
        projects: [
          {
            ...
            category: "Naval",
            description:
              "I perform a detailed analysis of projects in initial or ongoing phases, taking into account current regulations, technical feasibility and economic impact. The reports I prepare are designed to serve as a tool for strategic decision-making.",
            image: "/images/projects/project-1.jpg",
          },
          {
            ...
            category: "Industrial",
            description:
              "I determine if a project is viable from technical, economic and logistical points of view. This evaluation allows anticipating obstacles, estimating necessary resources and defining an effective action plan.",
            image: "/images/projects/project-2.jpg",
          },
          {
            ...
            category: "Offshore",
            description:
              "I accompany the execution of projects ensuring that technical standards, delivery deadlines and quality criteria are met. Supervision can be punctual or continuous, depending on the scope of the work.",
            image: "/images/projects/project-3.jpg",
          },
          {
            ...
            category: "Naval",
            description:
              "I identify opportunities for improvement in production lines or project execution, with the aim of reducing time, costs and errors. I work with methodologies such as Lean Manufacturing and Six Sigma.",
            image: "/images/projects/project-1.jpg",
          },
          {
            ...
            category: "Industrial",
            description:
              "I accompany companies and projects during technical certification processes and classification of ships or facilities, collaborating with recognized entities such as Bureau Veritas, DNV, Lloyd's Register or ABS.",
            image: "/images/projects/project-2.jpg",
          },
          {
            ...
            category: "Offshore",
            description:
              "I provide technical support to companies participating in international projects, ensuring adaptation to local and international regulations, coordination between multidisciplinary teams and monitoring of global quality standards",
            image: "/images/projects/project-3.jpg",
          },
        ],
      },
    ...
    naval: {
      es: {
        ...
        description:
          "Soluciones especializadas para embarcaciones y estructuras marítimas con los más altos estándares.",
      },
      en: {
        title: "Naval and Offshore Engineering",
        subtitle: "Experts in the maritime sector",
        description:
          "Specialized solutions for vessels and maritime structures with the highest standards.",
      },
      ca: {
        title: "Assistència Tècnica Internacional",
        subtitle: "Experts en el sector marítim",
        description:
          "Solucions especialitzades per a embarcacions i estructures marítimes amb els més alts estàndards.",
      },
    },
    cta: {
      es: {
        ...
        description:
          "Estamos listos para ayudarte con tu próximo proyecto de ingeniería.",
      ...
      en: {
        ...
        subtitle: "Contact us",
        description:
          "We are ready to help you with your next engineering project.",
      ...
      ca: {
        ...
        description:
          "Estem preparats per ajudar-te amb el teu proper projecte d'enginyeria.",
  ...
  const handleChange = (
    ...
    if (!content[section] || !content[section][language]) {
      console.error(
        `La sección ${section} o el idioma ${language} no existen en el contenido`
      );
      return;
    }
    ...
    >
      ...
      */}
      ...
      <div className="overflow-auto pb-20">
                ...
                <div className="flex items-center mb-2">
                  <span
                    className={`w-2 h-2 rounded-full mr-2 ${
                      activeTab === section ? "bg-white" : "bg-indigo-400"
                    }`}
                  ></span>
                  <h4 className="font-medium text-white">
                    {locale === "es"
                      ? editorText.sections[section]?.es || section
                      : locale === "en"
                      ? editorText.sections[section]?.en || section
        ...
        <div className="mb-8">{renderEditorFields()}</div>
      </div>
