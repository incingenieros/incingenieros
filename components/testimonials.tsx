...
export default function Testimonials() {
  ...
  useEffect(() => {
    // Filtrar testimonios cuando cambia la categoría
    if (category === 1) {
      ...
      <div className="pb-12 md:pb-20">
        ...
        <div className="inline-flex items-center gap-3 pb-3 before:h-px before:w-8 before:bg-linear-to-r before:from-transparent before:to-indigo-200/50 after:h-px after:w-8 after:bg-linear-to-l after:from-transparent after:to-indigo-200/50">
          ...
          <p className="text-lg text-indigo-200/65">
            Colaboraciones estratégicas con empresas líderes del sector marítimo e industrial que han transformado
            sus operaciones y mejorado su competitividad gracias a nuestras soluciones de ingeniería.
          </p>
          <div className="mt-4 flex justify-center">
            <span className="inline-flex items-center rounded-full bg-indigo-900/30 px-3 py-1 text-sm font-medium text-indigo-300">
              ...
              Empresas colaboradoras del sector marítimo e industrial
            </span>
          </div>
        </div>
